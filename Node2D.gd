...
#var vel = 10 #son las propiedades de la clase
#var dmg = 5
#func _ready():
	#movement()
	
	
#func movement(): #para que la clase realize cosas, se utilizan las funciones
...
#func explotion():
	#pass
#endregion
#region funciones heredadas y depuracion de codigo
#class_name proyectile #nombre de la clase
#extends Sprite2D
